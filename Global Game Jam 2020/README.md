...
You can win the game in two different ways:<br><br>
  &emsp;**1.** Getting to the goal before the other team does.<br><br>
  &emsp;**2.** If one team is so behind that it is no longer seen in the screen a 3 second countdown timer will start. If that team doesn't manage to get visible in the screen before the counter ends, the other team automatically wins the game.<br><br>
